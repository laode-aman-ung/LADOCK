...
echo "  ladock-desktop        # GUI workstation"
echo "  ladock-cli            # rule-based docking agent (guided wizard)"
echo ""
echo "If those are not on PATH yet, add $HOME/.local/bin, or run:"
echo "  bash $SCRIPT_DIR/ladock.sh"
echo ""
echo "Docking engines are not bundled in the install; fetch them once with:"
echo "  ladock-fetch-binaries"
