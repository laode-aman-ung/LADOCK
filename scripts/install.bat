...
"%PYTHON_EXE%" -m pip install -e "%ROOT_DIR%"
if errorlevel 1 (
    echo.
...
echo   ladock-cli            ^(rule-based docking agent^)
echo   OR double-click LADOCK.bat on your Desktop
echo.
echo Docking engines are not bundled; fetch them once with:
