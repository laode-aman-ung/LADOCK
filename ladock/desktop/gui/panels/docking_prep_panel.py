...
from ladock.desktop.gui.widgets.common import SectionLabel, HDivider, StatusBadge
...
class _PrepWorker(QObject):
    ...
    def run(self):
        try:
            from ladock.desktop.engine.mol_prep import prep_receptor, prep_ligand
...
class DockingPrepPanel(QWidget):
    ...
    def _build_ui(self):
        ...
        from ladock.desktop.app.about_dialog import _CITATION_HTML, _CITATION_PLAIN
        cite_box = QTextEdit()
