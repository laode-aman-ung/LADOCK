...
from ladock.desktop.gui.widgets.common import SectionLabel
from ladock.desktop.core.ligand_smiles import smiles_from_ccd, smiles_from_structure
...
QListWidget::item:hover { background: #2d333b; }
"""
...
QTableWidget::item:selected { background: #373e47; }
QHeaderView::section {
    background: #1c2128;
    color: #58a6ff;
    border: 1px solid #2d333b;
...
QTabBar::tab:selected { background: #2d333b; color: #58a6ff; }
QTabBar::tab:hover    { background: #22272e; }
"""
...
class _LigandDetailWidget(QWidget):
    ...
    def _build_ui(self):
        ...
        name_lbl.setStyleSheet("color:#58a6ff; font-size:12px;")
        hdr.addWidget(name_lbl)
        if self._energy:
            try:
                e = float(self._energy)
                color = ('#3fb950' if e <= -8 else '#d29922' if e <= -6 else '#f85149')
        ...
        if self._sf:
            ...
            sf_lbl.setStyleSheet("color:#79c0ff; font-size:11px;")
        ...
        from ladock.desktop.gui.panels.interaction_panel import ITYPE_COLORS, ITYPE_ICONS
        filter_bar = QWidget()
        filter_bar.setStyleSheet("background:#161b22;")
        fb_lay = QHBoxLayout(filter_bar)
        fb_lay.setContentsMargins(6, 2, 6, 2)
        fb_lay.setSpacing(8)
        show_lbl = QLabel("Show:")
        show_lbl.setStyleSheet("color:#8b949e; font-size:10px;")
        ...
        path_lbl.setStyleSheet("color:#545d68; font-size:10px;")
    ...
    def _on_filter_changed(self):
        ...
        if self._inter_tbl is not None and self._result is not None:
            ...
            if self._summary_bar is not None:
                from ladock.desktop.engine.interaction_analyzer import AnalysisResult
    ...
    def _make_placeholder(text: str) -> QLabel:
        ...
        lbl.setStyleSheet("color:#545d68; font-size:12px; background:#1c2128;")
        return lbl
    ...
    def _do_load(self):
        ...
        try:
            from ladock.desktop.engine.interaction_analyzer import (
        ...
        # ── 2D Diagram ──────────────────────────────────────────────────
        try:
            from ladock.desktop.gui.panels.interaction_panel import InteractionDiagram
        ...
        # ── Interaction Table ────────────────────────────────────────────
        try:
            from ladock.desktop.gui.panels.interaction_panel import InteractionTable, SummaryBar
...
class ResultExplorerPanel(QWidget):
    ...
    def _build_ui(self):
        ...
        # Left pane: file list
        left = QWidget()
        left.setFixedWidth(200)   # match EXPLORER / RECEPTOR READY width
        lv = QVBoxLayout(left)
        ...
        self._csv_label.setStyleSheet(
            "color:#545d68; font-size:11px; font-style:italic;")
        ...
        hint_lbl.setStyleSheet("color:#545d68; font-size:10px; font-style:italic;")
        ...
        self._summary_label.setStyleSheet("color:#545d68; font-size:11px;")
    ...
    def _load_and_render(self, csv_path: str):
        from ladock.desktop.data.result_parser import load_results_csv
        try:
        ...
        self._csv_label.setStyleSheet("color:#58a6ff; font-size:11px;")
