...
from ladock.desktop.gui.widgets.common import SectionLabel, HDivider, StatusBadge, apply_docking_tooltips
...
from ladock.desktop.engine.native_prep import (
    meeko_available,
...
from ladock.desktop.engine.mol_prep import (
...
class NativeRedockingPanel(QWidget):
    ...
    def _update_sf_params(self):
        ...
        from ladock.desktop.core.docking_features import any_supports_flex
        checked = []
