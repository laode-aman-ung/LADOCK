#!/usr/bin/env python3
"""
LADOCK Desktop — GUI entry point.

Launched by the ``ladock-desktop`` command (see pyproject.toml), or directly
with ``python -m ladock.desktop``.
"""
...
from ladock.desktop.app.main_window import MainWindow
from ladock.desktop.app.project_manager import WelcomeDialog
