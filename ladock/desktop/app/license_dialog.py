...
from ladock.desktop.core.license_manager import (
...
class LicenseDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        act_hint = QLabel(
            "The free academic license is active automatically — no key needed. "
            "If you purchased a <b style='color:#89b4fa'>commercial license</b>, "
...
class _StatusCard(QFrame):
    ...
    def update_info(self, info: LicenseInfo):
        ...
        if info.type == LicenseType.ACADEMIC_FREE and not info.name:
            self._name_label.setText("Free for everyone — non-commercial use")
            self._email_label.setText("No registration or license key required")
