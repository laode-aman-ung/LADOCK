...
from ladock.desktop.gui.panels.docking_prep_panel    import DockingPrepPanel
from ladock.desktop.gui.panels.native_redocking_panel import NativeRedockingPanel
from ladock.desktop.gui.panels.ligand_test_panel      import LigandTestPanel
from ladock.desktop.gui.panels.job_manager            import JobManagerPanel
from ladock.desktop.gui.panels.result_explorer        import ResultExplorerPanel
from ladock.desktop.app.settings_dialog  import SettingsDialog
from ladock.desktop.app.about_dialog     import AboutDialog
from ladock.desktop.app.license_dialog   import LicenseDialog
from ladock.desktop.app.documentation_dialog import DocumentationDialog
from ladock.desktop.app.project_manager  import ProjectManager, WelcomeDialog
from ladock.desktop.core.license_manager import load_license, LicenseStatus, LicenseType, ACADEMIC_FREE_UNTIL
from ladock.desktop.data.project import create_legacy_job_directory
...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        # Prep panel: "Generate Job Directory" is the same task as New Project
        self._panel_prep.new_project_requested.connect(self._project_mgr.action_new)
    ...
    def _on_prep_file_saved(self, path: str):
        """A prepared receptor file was saved to receptor_ready/."""
    ...
    def _on_job_registered(self, job):
        ...
        from ladock.desktop.core.job_scheduler import JobStatus
    ...
    def _build_menubar(self):
        ...
        self._add_action(help_menu, "📖  Documentation…", "F1",
    ...
    def _on_job_dir_changed(self, job_dir: str):
        ...
        # Persist docking job logs to job_dir/logs/
        self._panel_jobs.set_log_dir(os.path.join(job_dir, "logs"))
