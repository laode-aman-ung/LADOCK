#!/usr/bin/env python3
"""
Package your local, validated ``ladock/bin/<platform>/`` into archives to host
...
Output: ``build/bin-archives/bin-<platform>.tar.gz``
...
_BIN = _ROOT / "ladock" / "bin"
_OUT = _ROOT / "build" / "bin-archives"
