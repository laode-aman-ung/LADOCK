...
ACADEMIC FREE LICENSE (2024 – 2027)
  Free for verified university/research institution users.
  Requires institutional email (.ac.id / .edu / etc.).
  Non-commercial academic use only.
  Valid until: December 31, 2027.

ACADEMIC DISCOUNT (Post-2027)
